...
\urlstyle{same}
\hypersetup{
  pdftitle={Yıllık Sanayi ve Hizmet İstatistikleri},
  pdfauthor={MOHAMMAD AMJAD AFEEF MARMASH MOHAMMAD AMJAD AFEEF MARMASH},
  colorlinks=true,
  linkcolor={Maroon},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Yıllık Sanayi ve Hizmet İstatistikleri}
\author{MOHAMMAD AMJAD AFEEF MARMASH MOHAMMAD AMJAD AFEEF MARMASH\footnote{20080739}}
\date{}
...
\textbf{Proje önerisi gönderimi, ekampus sistemine bir zip dosyası yüklenerek yapılacaktır. Sisteme zip dosyası yüklemezseniz ara sınav ve final sınavlarına girmemiş sayılırsınız.}

\textbf{Proje klasörünüzü sıkıştırdıktan sonra (\texttt{ÖğrenciNo.zip} dosyası) 28 Nisan 2024 23:59'a kadar \emph{ekampus.ankara.edu.tr} adresine yüklemeniz gerekmektedir.}
